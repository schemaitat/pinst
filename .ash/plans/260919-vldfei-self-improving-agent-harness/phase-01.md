...
## Steps
- [ ] TASK-001: `.agents/skills/plan-learnings/SKILL.md` — define the lesson
...
- [ ] TASK-002: `.agents/skills/plan-learnings/SKILL.md` — add a
...
- [ ] TASK-003: `.ash/LEARNINGS.md` — backfill `Status:` on all ten lessons.
      ...
      it.
- [ ] TASK-004: `.ash/plans/*/learnings.md` — backfill `**Skill:**` on every
...
- [ ] TASK-005: `.agents/README.md` — document both fields where the corpus
